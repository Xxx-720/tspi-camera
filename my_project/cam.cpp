    ...
    , ui(new Ui::cam)
{
    ...
    videoView = new QGraphicsView(ui->widget);
    ...
    videoItem->setSize(QSize(640, 480));
...
//    set.setResolution(QSize(640, 480));
    set.setResolution(QSize(2112, 1184));
...
//    viewfinder->show();
    ...
    {
        connect(videoProbe, &QVideoProbe::videoFrameProbed, this, [this]() {
            frame_count++;  // 每一帧来就+1
        });
    }
